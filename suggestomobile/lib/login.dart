        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  labelText: "Email",
                  labelStyle: TextStyle(color: Color.fromARGB(139, 255, 255, 255), fontSize: 14, fontFamily: "Poppins"),
            ...
            if (mensagemErro.isNotEmpty)
              Text(
                mensagemErro,
                style: TextStyle(color: Colors.redAccent, fontSize: 13, fontFamily: "Poppins"),
              ),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: Color.fromARGB(187, 73, 8, 138),
